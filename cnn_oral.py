...
def main():
    ...
    # ---------------------------
    # 2. Load datasets (train on dataset 1, test on dataset 2)
    # ---------------------------
    ...
    # ---------------------------
    # 3. Train/val split (val comes only from dataset 1)
    # ---------------------------
    ...
    # ---------------------------
    # 4. Simple CNN — explicit Conv2d + MaxPool2d
    # ---------------------------
    ...
    # ---------------------------
    # 5. Loss (class-weighted), optimizer, scheduler
    # ---------------------------
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        test_loss, test_acc = evaluate(model, test_loader, criterion)  # monitoring only, not used for model selection
        ...
        # model selection is based on val_loss only — test set is never used to pick the model
    ...
    # ---------------------------
    # 8. Plot train/val/test accuracy and loss
    # ---------------------------
    ...
    # ---------------------------
    # 9. Final evaluation on unseen dataset 2 (best model)
    # ---------------------------
    ...
    print("\n=== Final cross-dataset test results (Simple CNN, trained on Dataset 1, tested on Dataset 2) ===")
